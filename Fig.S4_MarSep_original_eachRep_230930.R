...
g_seasons_sun_CCA1 <- ggplot(seasons_sun_CCA1, aes(x=Time, y=M, group=Condition, color=Condition)) + 
  annotate("rect", xmin = 12, xmax = 24, ymin = 0, ymax = 45, alpha = 0.3, fill = "gray50")+
  ...
  geom_point(data = seasons_sun, aes(color=Condition, y=CCA1), shape=19, size=0.2, alpha = 0.6, stroke = 1.2)+
  theme_classic(base_size = 7) +
  theme(legend.position = "none",
        legend.text = element_text(size = 7, colour = "black"),
        legend.title = element_text(size = 7, colour = "black"),
  ...
  scale_colour_manual(values=c("#FF1493", "#522A17"))+
  scale_fill_manual(values=c("#FF1493", "#522A17"))+
  scale_y_continuous(expand = c(0, 0), breaks=seq(0,40,20))+
  scale_x_continuous(breaks=seq(12,30,6))+
...
g_seasons_shaded_CCA1 <- ggplot(seasons_shaded_CCA1, aes(x=Time, y=M, group=Condition, color=Condition)) + 
  ...
  #               position=position_dodge(0.08)) +
  geom_line(aes(color=Condition), size= 1, alpha = 0.6) + 
  geom_point(data = seasons_shaded, aes(color=Condition, y=CCA1), shape=19, size=0.2, alpha = 0.6, stroke = 1.2)+
  theme_classic(base_size = 7) +
  theme(legend.position = "none",
        legend.text = element_text(size = 7, colour = "black"),
        legend.title = element_text(size = 7, colour = "black"),
...
g_seasons_sun_SIG5 <- ggplot(seasons_sun_SIG5, aes(x=Time, y=M, group=Condition, color=Condition)) + 
  annotate("rect", xmin = 12, xmax = 24, ymin = 0, ymax = 8, alpha = 0.3, fill = "gray50")+
  ...
  #               position=position_dodge(0.08)) +
  geom_line(aes(color=Condition), size= 1, alpha = 0.6) + 
  geom_point(data = seasons_sun, aes(color=Condition, y=SIG5), shape=19, size=0.2, alpha = 0.6, stroke = 1.2)+
  theme_classic(base_size = 7) +
  theme(legend.position = "none",
        legend.text = element_text(size = 7, colour = "black"),
        axis.title = element_text(size = 7, colour = "black"),
  ...
  scale_colour_manual(values=c("#FF1493", "#522A17"))+
  scale_fill_manual(values=c("#FF1493", "#522A17"))+
  scale_y_continuous(expand = c(0, 0), breaks=seq(0,8,4))+
  scale_x_continuous(breaks=seq(12,30,6))+
...
g_seasons_shaded_SIG5 <- ggplot(seasons_shaded_SIG5, aes(x=Time, y=M, group=Condition, color=Condition)) + 
  ...
  #               position=position_dodge(0.08)) +
  geom_line(aes(color=Condition), size= 1, alpha = 0.6) + 
  geom_point(data = seasons_shaded, aes(color=Condition, y=SIG5), shape=19, size=0.2, alpha = 0.6, stroke = 1.2)+
  theme_classic(base_size = 7) +
  theme(legend.position = "none",
        legend.text = element_text(size = 7, colour = "black"),
        legend.title = element_text(size = 7, colour = "black"),
...
g_seasons_sun_BLRP <- ggplot(seasons_sun_BLRP, aes(x=Time, y=M, group=Condition, color=Condition)) + 
  annotate("rect", xmin = 12, xmax = 24, ymin = 0, ymax = 10, alpha = 0.3, fill = "gray50")+
  # annotate("text", x = 28, y = 4, label = "*", size = 5, color = "black")+
  # geom_errorbar(aes(ymin=M-SE, ymax=M+SE), width = 0.8, size = 0.8, 
  #               position=position_dodge(0.08)) +
  geom_line(aes(color=Condition), size= 1, alpha = 0.6) +
  geom_point(data = seasons_sun, aes(color=Condition, y=BLRP), shape=19, size=0.2, alpha = 0.6, stroke = 1.2)+
  theme_classic(base_size = 7) +
  theme(legend.position = "none",
        legend.text = element_text(size = 7, colour = "black"),
        legend.title = element_text(size = 7, colour = "black"),
  ...
  scale_colour_manual(values=c("#FF1493", "#522A17"))+
  scale_fill_manual(values=c("#FF1493", "#522A17"))+
  scale_y_continuous(expand = c(0, 0), breaks=seq(0,10,5))+
  scale_x_continuous(breaks=seq(12,30,6))+
...
g_seasons_shaded_BLRP <- ggplot(seasons_shaded_BLRP, aes(x=Time, y=M, group=Condition, color=Condition)) + 
  ...
  #               position=position_dodge(0.08)) +
  geom_line(aes(color=Condition), size= 1, alpha = 0.6) + 
  geom_point(data = seasons_shaded, aes(color=Condition, y=BLRP), shape=19, size=0.2, alpha = 0.6, stroke = 1.2)+
  theme_classic(base_size = 7) +
  theme(legend.position = "none",
        legend.text = element_text(size = 7, colour = "black"),
        legend.title = element_text(size = 7, colour = "black"),
...
ggsave("figures/Fig.S4_MarSep_original_eachRep_230930.pdf",
